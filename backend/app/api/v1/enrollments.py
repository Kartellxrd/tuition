...
def serialize(e: Enrollment) -> EnrollmentResponse:
    return EnrollmentResponse(id=e.id, student_id=e.student_id, module_id=e.module_id, module_code=e.module.code if e.module else None, module_name=e.module.name if e.module else None, tier=e.tier, status=e.status, expected_price=e.expected_price, payment_reference=e.payment_reference, rejection_reason=e.rejection_reason, reviewed_at=e.reviewed_at, reviewed_by=e.reviewed_by, created_at=e.created_at)
